...
function createJobConfig(DATA_DIR) {
  ...
  const POSITION_SCORING_RULES = {
    ...
    "外部财务产品顾问": {
      title: "外部财务产品顾问评分规则",
      description: "重点看候选人是否能把真实 B2B 企业财务管理经验转成 AI 财务产品可复用的规则、指标、流程和审核边界。",
      mustHave: [
        "8 年以上企业财务、财务管理、业财融合、财务 BP、CFO 顾问或财务数字化经验。",
        "熟悉 B2B 企业销售、合同、订单、发票、回款和应收账款流程。",
        "熟悉账龄分析、现金流管理、经营分析和管理报表。",
        "能将财务经验转化为清晰规则、流程、指标口径和产品需求。",
        "能审核 AI 生成的财务分析、催款建议、经营建议或老板报告是否符合财务逻辑和企业场景。"
      ],
      bonus: [
        "做过财务总监、财务经理、财务 BP、CFO 顾问、管理会计或业财融合项目。",
        "管过应收账款、账期、回款、客户授信、坏账管理、逾期分级或风险预警。",
        "有 SAP、Oracle、用友、金蝶、ERP、CRM、财务系统或数字化转型项目经验。",
        "有制造业、贸易公司、工业品、化工材料、供应链企业经验。",
        "参与过客户访谈、售前 POC、财务指标字典、经营驾驶舱或 AI 输出审核规则设计。"
      ],
      risks: [
        "只有基础会计核算、记账或报税经验，缺少财务管理、应收回款和经营分析视角。",
        "不了解 B2B 销售、合同、订单、发票、回款和应收流程。",
        "只能做咨询表达，不能沉淀规则、指标、流程或产品需求。",
        "完全排斥 AI 产品设计，或无法审核 AI 输出的专业边界。"
      ]
    },
    "投资交易策略研究员（量化与市场情绪方向）": {
      title: "投资交易策略研究员（量化与市场情绪方向）评分规则",
      description: "重点看二级市场股票短周期信号、市场情绪、量化分析、交易执行支持和复盘能力，不按传统行业研究员或纯交易员标准打分。",
      mustHave: [
        "本科及以上，数学、统计、金融工程、计算机、物理、电子工程、经济金融等相关专业优先。",
        "熟悉股票市场交易机制，理解市场情绪、资金行为、板块轮动、量价关系和短周期交易逻辑。",
        "能用 Python 做数据处理、策略回测、因子分析、交易信号监控或可视化。",
        "具备扎实数学、统计和数据分析基础，能把市场判断转成指标、模型信号或交易规则。",
        "有风险意识，理解仓位管理、止盈止损、流动性、滑点、交易成本和回撤控制。"
      ],
      bonus: [
        "有股票实盘交易、策略研究、量化研究、交易支持、私募、券商自营、家办、量化团队或交易团队经验。",
        "做过动量、反转、趋势跟踪、均值回归、因子选股、行业轮动、事件驱动或市场情绪策略研究/回测。",
        "熟悉 Pandas、NumPy、Statsmodels、Scikit-learn、Wind、Bloomberg、同花顺 iFinD、Choice、聚宽、米筐或 TradingView。",
        "有市场情绪模型、新闻情绪分析、社交媒体情绪分析、NLP、机器学习、Level-2、盘口或高频数据经验。",
        "熟悉 AI、半导体、芯片、算力、光模块、服务器、存储、机器人、智能硬件等科技成长方向。",
        "有可展示的策略回测、交易复盘、投资研究报告、模拟盘或实盘交易记录。"
      ],
      risks: [
        "只有传统行业研究、宏观基本面研究或投研报告经验，缺少短周期交易、量化信号或盘面经验。",
        "只会泛泛写 Python 或金融关键词，缺少回测、因子、交易执行、风险控制或复盘证据。",
        "只做软件开发或普通数据分析，完全不了解股票市场和交易机制。",
        "风险控制、仓位、止损、滑点、交易成本意识弱，或不能在盘中给出可执行建议。"
      ]
    },
    "AI智能体解决方案负责人": {
      title: "AI智能体解决方案负责人评分规则",
      description: "重点看候选人能否把财务业务规则转成 AI Workflow、数据模型、工具调用、Demo、评测体系和可复制交付方案。",
      mustHave: [
        "3 年以上 AI 应用、企业 SaaS、数据产品、BI、RPA、ERP/CRM 实施或解决方案架构经验。",
        "熟悉 LLM、RAG、Agent、Prompt、工具调用、Workflow 等 AI 应用能力。",
        "熟悉 Python 和 SQL，能处理 Excel、数据库和 API 数据。",
        "能理解企业财务、销售、订单、发票、回款、应收账款等基础业务流程。",
        "具备业务抽象和产品化能力，能把财务规则转成数据模型、Workflow、工具接口和产品功能。",
        "能与客户、财务顾问、产品和工程团队沟通，并推动 Demo 或 POC 交付。"
      ],
      bonus: [
        "做过财务 Copilot、销售 Copilot、企业知识库、数据分析 Agent、经营分析或应收回款类 AI 应用。",
        "有 CRM、ERP、BI、RPA、财务系统或 B2B 企业数字化项目经验。",
        "有 Evaluation、Harness、AI 输出评测、幻觉控制、Prompt 模板或工具调用设计经验。",
        "有 Forward Deployed Engineer、解决方案架构师、售前方案或客户现场交付背景。",
        "能沉淀标准化产品模块、Workflow 模板、Prompt 模板、交付 SOP 和 POC 成功标准。"
      ],
      risks: [
        "只做传统项目管理或售前 PPT，缺少 AI Workflow、工具调用、数据模型或 Demo 落地能力。",
        "只懂 AI 技术但完全不理解企业财务、销售、订单、发票、回款和应收流程。",
        "只做底层算法或模型训练，缺少企业应用、客户交付和产品化经验。",
        "不能用 Python 或 SQL 处理业务数据，无法独立搭建 Demo 或验证方案。"
      ]
    }
  };
  ...
  const JD_PROFILE_DEFINITIONS = [
    ...
    {
      id: "external_finance_product_advisor",
      jobType: "外部财务产品顾问",
      shortTitle: "财务顾问",
      matchedJobTypes: ["外部财务产品顾问"],
      targetRoles: ["外部财务产品顾问", "业财智能化顾问", "AI财务场景顾问", "财务数字化顾问", "CFO顾问"],
    },
    {
      id: "investment_strategy_researcher",
      jobType: "投资交易策略研究员（量化与市场情绪方向）",
      shortTitle: "投资策略研究",
      matchedJobTypes: ["投资交易策略研究员（量化与市场情绪方向）"],
      targetRoles: ["投资交易策略研究员", "量化交易研究员", "市场情绪研究员", "股票量化策略", "交易支持"],
    },
    {
      id: "ai_agent_solution_lead",
      jobType: "AI智能体解决方案负责人",
      shortTitle: "AI方案负责人",
      matchedJobTypes: ["AI智能体解决方案负责人"],
      targetRoles: ["AI智能体解决方案负责人", "AI Solution Architect", "AI FDE", "AI Workflow Engineer", "Agent解决方案"],
    },
  ];
